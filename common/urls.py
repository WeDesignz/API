...
urlpatterns = [
    ...
    path('instagram/check-image/', views.instagram_check_image, name='instagram_check_image'),
    path('instagram/check-image', views.instagram_check_image, name='instagram_check_image_no_slash'),
